...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ghosts = _react2.default.createClass({
	  ...
	  getStyles: function getStyles(prevStyles) {
	    ...
	    var endValue = prevStyles.map(function (_, i) {
	      return i === 0 ? _this.state : {
	        x: (0, _reactMotion.spring)(prevStyles[i - 1].x, presets.gentle),
	        y: (0, _reactMotion.spring)(prevStyles[i - 1].y, presets.gentle)
	      };
	    });
	    return endValue;
	  },
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      {
	        defaultStyles: [0, 1, 2, 3].map(function (e, i) {
	          return { x: 0, y: 0 };
	        }),
	...
	ReactDOM.render(_react2.default.createElement(Ghosts, null), document.getElementById('ghosts'));
